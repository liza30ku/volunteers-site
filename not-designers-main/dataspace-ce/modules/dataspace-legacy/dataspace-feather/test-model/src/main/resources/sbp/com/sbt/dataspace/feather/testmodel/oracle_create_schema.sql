...
(
    ...
    P13       CHAR(1),
    P14       DATE,
    P15       TIMESTAMP(3) WITH LOCAL TIME ZONE,
    R1        VARCHAR2(256),
    G1_P1     VARCHAR2(4000),
    G3_R1     VARCHAR2(256)
);
...
(
    AGGREGATE VARCHAR2(256) NOT NULL PRIMARY KEY,
    VERSION   NUMBER(19, 0)
);
-- }
...
(
    ...
    AGGREGATE            VARCHAR2(256),
    CODE                 VARCHAR2(4000),
    CREATED_ENTITY       VARCHAR2(256) UNIQUE,
    AGREEMENT            VARCHAR2(256) UNIQUE,
    INITIATOR_FIRST_NAME VARCHAR2(4000),
    INITIATOR_LAST_NAME  VARCHAR2(4000),
    INITIATOR_AGE        NUMBER(10, 0),
    INITIATOR_DOCUMENT   VARCHAR2(256),
    DESCRIPTION          VARCHAR2(4000),
    SPECIAL_CODE         VARCHAR2(4000)
);
...
(
    ID                    VARCHAR2(256) NOT NULL PRIMARY KEY,
    MANAGER_PERSONAL_CODE NUMBER(19, 0),
    START_ACTION          VARCHAR2(256),
    INITIATOR_FIRST_NAME  VARCHAR2(4000),
    INITIATOR_LAST_NAME   VARCHAR2(4000),
    INITIATOR_AGE         NUMBER(10, 0),
    INITIATOR_DOCUMENT    VARCHAR2(256)
...
(
    ID              VARCHAR2(256) NOT NULL PRIMARY KEY,
    CREATOR_CODE    NUMBER(19, 0),
    RELATED_PRODUCT VARCHAR2(256),
    MAIN_DOCUMENT   VARCHAR2(256)
);
...
(
    OWNER   VARCHAR2(256),
    ELEMENT VARCHAR2(4000) NOT NULL,
...
(
    OWNER   VARCHAR2(256),
    ELEMENT BINARY_DOUBLE NOT NULL,
